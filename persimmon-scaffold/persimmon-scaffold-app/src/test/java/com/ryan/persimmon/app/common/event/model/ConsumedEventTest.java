package com.ryan.persimmon.app.common.event.model;
...
class ConsumedEventTest {
  ...
  void headers_defaultsToEmpty_and_isDefensivelyCopied() {
    ...
    ConsumedEvent e0 =
        new ConsumedEvent(eventId, "t", occurredAt, "Agg", aggregateId, "{}", null);
    ...
    src.put("traceId", "t-1");
    ConsumedEvent e1 =
        new ConsumedEvent(eventId, "t", occurredAt, "Agg", aggregateId, "{}", src);
