...
import com.acme.persimmon.demo.tenantprovisioning.app.common.workflow.port.WorkflowStore.WorkflowStepToInsert;
...
class WorkflowRunnerTest {
  ...
  private static WorkflowRunner createRunner(
    ...
    OutboxStore noopOutbox =
        new OutboxStore() {
          @Override
          public void append(List<com.acme.persimmon.demo.tenantprovisioning.app.common.outbox.model.OutboxMessage> messages) {}

          @Override
          public List<com.acme.persimmon.demo.tenantprovisioning.app.common.outbox.model.OutboxMessage> claimNextBatch(
